...
public class YoutubeVideo extends AsyncTask {
    ...
    public void downloadAsync(Format format, File outDir, String fileName, boolean overwrite, OnYoutubeDownloadListener listener) throws IOException, YoutubeException {
        if (videoDetails.isLive() || (videoDetails.isLiveContent() && videoDetails.lengthSeconds() == 0))
            throw new YoutubeException.LiveVideoException("Can not download live stream");
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String fileName2 = outputFile.getName();
                    ...
                    while ((count = bis.read(buffer, 0, 1024)) != -1) {
                        ...
                        if (newProgress > progress) {
                            ...
                            listener.onDownloading(progress, fileName2);
                        }
                    }
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        Format format = (Format) objects[0];
        File outDir = (File) objects[1];
        String fileName = (String) objects[2];
        boolean overwrite = (boolean) objects[3];
        OnYoutubeDownloadListener listener = (OnYoutubeDownloadListener) objects[4];
